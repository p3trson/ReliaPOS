...
public class Stock extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panel_stock.setBackground(new java.awt.Color(72, 72, 72));
        panel_stock.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "testdrink", "drinks",  new Integer(10),  new Integer(20),  new Integer(200)}
            },
            new String [] {
                "ID", "Name", "Group", "Cost", "Sale price", "Quantity"
            }
        ) {
        ...
        panel_stockLayout.setHorizontalGroup(
            ...
            .addGroup(panel_stockLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panel_stockLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_stockLayout.createSequentialGroup()
